/*
    ...
    After logging in, a user will be sent to whichever view they corresponds 
    with their userType (sellers served sellerView, buyers buyerView, and 
    administrators mainView). From their, the user will find a select and 
    ...
    information or logout from the button labeled account, or view and update
