...
public class searchController {
    ...
    @FXML // fx:id="moreDetailsLabel2"
    private Label moreDetailsLabel2; // Value injected by FXMLLoader
    ...
    private Label moreDetailsButton3; // Value injected by FXMLLoader
    ...
    private Label moreDetailsButton4; // Value injected by FXMLLoader
    ...
    void initialize() {
        ...
        assert moreDetailsLabel2 != null : "fx:id=\"moreDetailsLabel2\" was not injected: check your FXML file 'searchView.fxml'.";
